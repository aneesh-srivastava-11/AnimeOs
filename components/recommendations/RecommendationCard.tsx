        ...
        <div className="space-y-2">
          <div className="flex items-start justify-between gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-1 rounded-md border border-[#27272A] bg-[#09090B] px-3 py-1.5 text-xs font-medium text-[#F4F4F5] hover:bg-[#141417] transition-colors shrink-0"
            >
              <span>AniList</span>
